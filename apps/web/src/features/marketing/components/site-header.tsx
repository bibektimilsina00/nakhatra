  ...
  return (
    <div ref={navRef as React.RefObject<HTMLDivElement>}>
      <header
          ...
          <nav className="hidden items-center gap-0.5 lg:flex" aria-label="Main">
            <div className="navmenu relative">
              ...
              <div className="navpanel absolute left-0 top-full pt-3">
                <div className="w-[560px] rounded-[8px] border border-brd bg-inset/95 p-2 shadow-2xl shadow-black/50 backdrop-blur-xl">
                  <div className="grid grid-cols-2 gap-0.5"><a href="#chart" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                ...
                </a><a href="#reading" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                ...
                </a><a href="#ask" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                ...
                </a><a href="#milan" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                ...
                </a><a href="#astrologers" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                  ...
                  <div className="mt-1 flex items-center justify-between gap-4 rounded-[6px] border-t border-brd px-3 py-2.5">
            ...
            <div className="navmenu relative">
              ...
              <div className="navpanel absolute left-0 top-full pt-3">
                <div className="w-[340px] rounded-[8px] border border-brd bg-inset/95 p-2 shadow-2xl shadow-black/50 backdrop-blur-xl">
                  <a href="/kundali" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                    <span className="mt-px shrink-0 text-faint transition-colors group-hover/i:text-gold"><svg className="size-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3.5" y="3.5" width="17" height="17" rx="1.5"/><path d="M12 3.5 20.5 12 12 20.5 3.5 12Z"/></svg></span>
                    <span className="min-w-0">
                  ...
                  <a href="/milan" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                    <span className="mt-px shrink-0 text-faint transition-colors group-hover/i:text-gold"><svg className="size-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20s-7-4.2-7-9a4 4 0 0 1 7-2.6A4 4 0 0 1 19 11c0 4.8-7 9-7 9Z"/></svg></span>
                    <span className="min-w-0">
        ...
        <Link
          href="/login"
          className="hidden items-center rounded-[8px] border border-brd px-6 py-2 text-[14px] text-muted transition-colors hover:border-brd2 hover:bg-fg/[0.04] hover:text-paper sm:inline-flex"
        >
          {nav.signIn}
        </Link>
      )}
        ...
        <div id="mobnav" hidden={!mobOpen} className="border-t border-brd bg-inset/97 backdrop-blur-xl lg:hidden">
          <nav className="mx-auto max-w-[1360px] px-8 py-5" aria-label="Mobile" onClick={(e) => {
            ...
            <div className="grid gap-x-8 gap-y-1 sm:grid-cols-2"><a href="#chart" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                  <span className="mt-px shrink-0 text-faint transition-colors group-hover/i:text-gold"><svg className="size-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3.5" y="3.5" width="17" height="17" rx="1.5"/><path d="M12 3.5 20.5 12 12 20.5 3.5 12Z"/></svg></span>
                  <span className="min-w-0">
                    <span className="flex items-center text-[13.5px] font-medium text-paper">{menu.features[0].title}</span>
                    <span className="mt-0.5 block text-[12px] leading-[1.55] text-faint">{menu.features[0].body}</span>
                ...
                </a><a href="/kundali" className="group/i flex gap-3 rounded-[6px] p-2.5 transition-colors hover:bg-fg/[0.05]">
                  <span className="mt-px shrink-0 text-faint transition-colors group-hover/i:text-gold"><svg className="size-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3.5" y="3.5" width="17" height="17" rx="1.5"/><path d="M12 3.5 20.5 12 12 20.5 3.5 12Z"/></svg></span>
                  <span className="min-w-0">
                    <span className="flex items-center text-[13.5px] font-medium text-paper">{nav.kundaliCreateTitle}</span>
                    <span className="mt-0.5 block text-[12px] leading-[1.55] text-faint">{nav.kundaliCreateBody}</span>

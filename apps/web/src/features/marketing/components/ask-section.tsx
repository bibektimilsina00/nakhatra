          ...
          <div className="reveal overflow-hidden rounded-[8px] border border-white/10 bg-card">
            ...
            <div className="border-t border-white/10 bg-ink/30 p-5 sm:p-6">
              <div className="mb-3 flex flex-wrap gap-2">
                <a href="#form" className="rounded-full border border-white/10 px-3 py-1 text-[12px] text-muted transition-colors hover:border-gold/40 hover:text-paper">{m.chips[0]}</a>
                <a href="#form" className="rounded-full border border-white/10 px-3 py-1 text-[12px] text-muted transition-colors hover:border-gold/40 hover:text-paper">{m.chips[1]}</a>
                <a href="#form" className="rounded-full border border-white/10 px-3 py-1 text-[12px] text-muted transition-colors hover:border-gold/40 hover:text-paper">{m.chips[2]}</a>
              </div>

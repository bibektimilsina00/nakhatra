    ...
    <section id="pillars" className="py-24">
      <div className="mx-auto max-w-[1360px] px-8">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,.85fr)_minmax(0,1.15fr)] lg:gap-16">
          ...
          <div className="reveal relative min-h-[430px] overflow-hidden rounded-[8px] border border-brd bg-card/70" data-d="1">
            ...
            >
              <div className="min-h-0 flex-1"><div className="flex h-full items-center gap-8">
                ...
                <dl className="min-w-0 flex-1 border-t border-brd font-mono text-[11.5px]">
                  <div className="flex items-baseline justify-between gap-3 border-b border-brd py-2"><dt className="text-faint">{p.lagna}</dt><dd className="tabular-nums text-gold2">{ch.statValues[0]}</dd></div>
                  <div className="flex items-baseline justify-between gap-3 border-b border-brd py-2"><dt className="text-faint">{p.nakshatra}</dt><dd className="tabular-nums text-gold2">{ch.statValues[2]}</dd></div>
                  <div className="flex items-baseline justify-between gap-3 border-b border-brd py-2"><dt className="text-faint">{p.vargas}</dt><dd className="tabular-nums text-gold2">16</dd></div>
              ...
              <div className="min-h-0 flex-1"><div className="flex h-full flex-col">
                ...
                <div className="mt-auto pt-5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    <span className="rounded-[5px] border border-brd bg-ink px-2 py-1 text-[11px] text-paper">{p.tenthHouse}</span>
                    <span className="rounded-[5px] border border-brd bg-ink px-2 py-1 text-[11px] text-paper">{refs[1]}</span>
                    <span className="rounded-[5px] border border-brd bg-ink px-2 py-1 text-[11px] text-paper">{refs[2]}</span>
                  </div>
                </div>
              </div></div>
            ...
            >
              <div className="min-h-0 flex-1"><div className="flex h-full flex-col justify-center gap-3">
                ...
                <div className="w-fit max-w-[92%] space-y-2.5 rounded-[8px] border border-brd bg-ink px-3.5 py-3">
                  ...
                  <div className="flex flex-wrap gap-1.5 border-t border-brd pt-2">
                    <span className="rounded border border-brd px-1.5 py-0.5 text-[10.5px] text-faint">{p.tenthLord}</span>
                    <span className="rounded border border-brd px-1.5 py-0.5 text-[10.5px] text-faint">{refs[2]}</span>
                  </div>
                </div>
                <div className="mt-2 flex items-center gap-3 rounded-[8px] border border-brd bg-ink px-3.5 py-2.5">
            ...
            >
              <div className="min-h-0 flex-1"><div className="flex h-full flex-col">
                ...
                <ul className="mt-auto space-y-2.5 border-t border-brd pt-5">
            ...
            >
              <div className="min-h-0 flex-1"><div className="flex h-full flex-col">
                ...
                <ul className="mt-4">
                  <li className="flex items-center gap-4 border-b border-brd py-3.5 last:border-0">

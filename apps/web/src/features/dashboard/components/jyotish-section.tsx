  ...
  return (
    <section id="jyotish" className="mt-14 scroll-mt-24">
      <div className="flex flex-wrap items-baseline justify-between gap-3 border-b border-white/[0.09] pb-3">
        <h2 className="text-[17px] font-bold text-fg">{t.dashJyotish}</h2>
        <Link
          href="/practitioners/apply"
          className={`inline-flex items-center gap-1.5 text-[11px] text-acc transition-colors hover:text-acc2 ${label}`}
        >
          {t.practApplyTitle}

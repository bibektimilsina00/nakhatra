  ...
  return (
    <section id="jyotish" className="mt-14 scroll-mt-24">
      <div className="flex flex-wrap items-baseline justify-between gap-3 border-b border-line pb-3">
        <h2 className="text-lg font-bold text-ink">{t.dashJyotish}</h2>
        <Link
          href="/practitioners/apply"
          className={`inline-flex items-center gap-1.5 text-xs text-accent-strong transition-colors hover:text-accent-ink ${label}`}
        >
          {t.practApplyTitle}

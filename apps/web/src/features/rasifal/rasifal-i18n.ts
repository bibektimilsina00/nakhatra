...
export const RASHI_SYLLABLES: string[][] = [
  ...
  // U.Ashadha 2-4, Shravana 1-4 (Nepali patro variant), Dhanishta 1-2. The
  // old row mixed the जु-variant in and dropped गा/गी entirely, so anyone
  // named Ga-/Gi- could not find their sign.
